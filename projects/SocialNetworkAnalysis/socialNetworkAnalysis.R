library(igraph)
g <- graph(c(1,2,2,3,3,4,4,1), directed = T)
...
#Network Diagram
set.seed(222)
plot(net, vertex.color='green', vertext.size =2,  edge.arror.size=0.1, vertex.label.cex=0.8)

#Highlighting degrees and layots
plot(net,
