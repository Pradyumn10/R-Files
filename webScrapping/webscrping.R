...
# Step 8
#The length of meta score data is 97 while we are scraping the data for 100 movies. The reason this happened is because there are 3 movies which don't have the corresponding Metascore fields.
...
for (i in c(1,2,7,10,20,21,22,24,25,26,29,30,31,34,36,37,38,41,42,43,44,50,
            51,52,53,54,57,66,68,70,74,76,78,80,82,84,85,86,88,89,90,93,95,96,98,100)){
...
# Rating
# ggplot(gross_data,aes(x=Runtime,y=Gross_Earning_in_Mil))+
